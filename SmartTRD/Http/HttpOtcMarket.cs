...
namespace SmartTRD.Http
{
    class HttpOtcMarket
    {
        private static string m_otcFullProfileMarket = "https://backend.otcmarkets.com/otcapi/company/profile/full/";

        public static string GetStrFromSymbolProfileOtcMarket(string symbol_A)
        {
            string returnInfo = "";
            string urlOfSymbol = "https://backend.otcmarkets.com/otcapi/company/profile/"+symbol_A +"/badges?symbol="+symbol_A;
        ...
        public static string GetStrFromFullProfileOtcMarket(string symbol_A)
        {
            string returnInfo = "";
            string urlOfSymbol = m_otcFullProfileMarket + symbol_A;
